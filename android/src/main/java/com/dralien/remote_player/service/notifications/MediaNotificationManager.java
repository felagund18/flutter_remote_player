...
package com.dralien.remote_player.service.notifications;
...
import com.dralien.remote_player.R;
import com.dralien.remote_player.RemotePlayerPlugin;
    ...
    private NotificationCompat.Builder buildNotification(@NonNull PlaybackStateCompat state,
        ...
        try {
            ...
            builder.setStyle(
                    ...
                    .setColor(ContextCompat.getColor(mService, R.color.peterRiver))
...
//            }
    ...
    private PendingIntent createContentIntent() {
        Intent openUI = new Intent(mService, RemotePlayerPlugin.shared.registrar.activity().getClass());
        openUI.putExtra("from", "notification");
