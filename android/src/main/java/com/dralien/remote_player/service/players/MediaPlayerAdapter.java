...
package com.dralien.remote_player.service.players;
...
import com.dralien.remote_player.service.PlaybackInfoListener;
import com.dralien.remote_player.service.PlayerAdapter;
...
//        play();
    ...
    @Override
    public void onStop() {
        try {// Regardless of whether or not the MediaPlayer has been created / started, the state must
